---
title: "Introduction to messydates"
...
Expand functions expand on date ranges, sets of dates, and unspecified or 
approximate dates (annotated with '..', '{ , }', 'XX' or '~') to lists of dates.
...
It contracts a list of dates into the abbreviated annotation of messy dates.
...
Additionally, perform intersection (`md_intersect()`) and union (`md_union()`) on, 
