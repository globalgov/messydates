...
\pkg{messydates} facilitate the annotation and the conversion of
...
\pkg{manydata} contains a database on Roman Emperors composed of three
datasets. We can also use \pkg{manydata} to ``consolidate'' the database
...
observations will be matched. Then, we use \pkg{dplyr} in combination
with \pkg{messydates} to create three different date variables to be our
...
how Roman Emperors rose to power. We use \pkg{stargazer} to visualize
