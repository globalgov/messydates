...
#' The data was retrieved on 2022-07-18.
#'
...
#'   \item{US_party}{is the US part to the conflict, numeric}
#'   \item{n_actors}{number of parties involved in the conflict, numeric}
#' }
#' @details
