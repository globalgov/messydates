...
of dates. This greatly facilitates research transparency and robustness
checks as we will demonstrate below.
...
# A tibble: 11 x 6
 ...
 1 A normal date       2022-09-09       2022-09-09 2022-09-09 2022-09-09 2022-0~
...
The `expand()´ function transform date ranges, sets of dates, and
...
2 2001-01-01 2001-01-31 2001-01-16 2001-01-16 2001-01-01 2001-01-18
3 2001-01-01 2001-02-01 2001-01-17 2001-01-16 2001-01-01 2001-01-01
4 2001-01-01 2001-02-01 2001-02-01 2001-01-16 2001-01-01 2001-02-01
...
objects. Or perform a `join' that retains all elements, even if
duplicated, with \texttt{md\_multiset}.
...
because the US military capabilities. Using \pkg{messydates} we create
...
Although not statistically significant, the coefficient for US being a
party in a conflict goes from being positive, when calculated using
arbitrary cut off dates, to being negative, when calculated using random
dates. In this case, setting arbitrary cut off points to dates
...
\begin{center}\includegraphics{article_files/figure-latex/outliers-1} \end{center}
