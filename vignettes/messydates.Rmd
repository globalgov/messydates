...
This date class implements [ISO 8601-2_2019(E)](https://www.iso.org/standard/70908.html) allowing regular dates to be annotated to express unspecified date components, approximate or uncertain date components, date ranges, and sets of dates.
...
Some datasets might have an arbitrary cut off point for start and end points, that is, they are censored.
...
Expand functions transform date ranges (annotated with '..'), sets of dates (annotated with '{ , }'),
