...
Several historical facts are contested. However, up to this point, dealing with negative historical dates in R was difficult and only manageable if authors made arbitrary choices to complete dates, making them biased, or left these in character class, instead of date class, limiting their analytical usefulness. Take, for example, the population sizes in the Roman Empire, which has been a topic of heated debates among some academics (see Scheidel 2008). Various accounts diverge in how they estimate population size and, therefore, the conclusions about the of the population at certain points in time differs (Scheidel 2008). Below, we build a dataset for the populations of mainland Italy during the Roman Empire (Scheidel 2008, p. 31) to illustrate how \pkg{messydates} facilitate the annotation and the conversion of historical dates for analysis.  
