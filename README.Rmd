...
with various kinds of date messiness.
...
(with fractional seconds), am/pm times, the UTC designator `Z`, and numeric
offsets such as `+02:00` are all parsed and standardised. Time components
accept the same approximate (`~`), uncertain (`?`), and unspecified (`X`)
