test_that("Expand dates works properly for date ranges and unspecified dates", {
  ...
  expect_equal(as.character(expand(range)), "c(\"2014-01-01\", \"2014-01-02\", \"2014-01-03\")")
  expect_equal(as.character(expand(unspecified)[[1]][1]), "1999-01-01")
  expect_equal(as.character(expand(unspecified)[[1]][365]), "1999-12-31")
